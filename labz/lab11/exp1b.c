/*
	cpe310L, lab 11, exp1b
	the DC motor is controlled by a potentiometer
	...
	f_pwm = f_cpu / (N * [1 + ICR1]),, --> ICR1 as top @ 1249
*/
...
#define DC_WIDTH 1249    // sets ICR1 to get required frequency
#define DC_MIN 0         // for motor enable, 0% duty cycle
#define DC_MAX 1023      // for motor enable, 98% duty cycle ... maps 1:1
