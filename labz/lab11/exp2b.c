/*
	cpe310L, lab 11, exp 2b
	the stepper is controlled by a potentiometer, DIP for direction
	...
	DirCntl    --> PD7    // motor direction control, PD7
...
#define PIN_DIR 7       // motor direction control, PD7
...
uint16_t stepper_pause_us;         // motor speed
...
int main(void)
{
	...
	DDRD &= ~(1 << PIN_DIR);
	PORTD |= (1 << PIN_DIR);                         // turn on pull up for direction control
